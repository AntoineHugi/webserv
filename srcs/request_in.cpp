...
// 			req._status_code = 500;
// 			return 1;  // Signal to close
// 	}
// 	return 0;
// }

// void handle_read(std::map<int, Client> &clients, std::vector<struct pollfd> &poll_fds, size_t i)
// {
...
// 		return;
// 	}
// 	if(fill_request_data(poll_fds[i].fd, clients[poll_fds[i].fd]._request))
// 	{
...
// void handle_write(std::map<int, Client> &clients, std::vector<struct pollfd> &poll_fds, size_t i)
// {
// 	std::cout << "==>>  Client will receive answer" << std::endl;

// 	std::string res = format_response(clients[poll_fds[i].fd]._request);
...
// 	// // if status code error -> close connection
...
// 		clients[poll_fds[i].fd]._request.flush_request_data();
...
// 	}
// }
// void handle_disconnect(std::map<int, Client> &clients, std::vector<struct pollfd> &poll_fds, size_t i)
// {
// 	(void)i;
// 	(void)clients;
// 	(void)poll_fds;
